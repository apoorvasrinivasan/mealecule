 ...
 */
package com.mealecule.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(MealeculeFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MealeculeFulfilmentProcessConstants.PARENT_PROCESS);
