 ...
 */
package com.mealecule.initialdata.setup;
...
import com.mealecule.initialdata.constants.MealeculeInitialDataConstants;
 ...
 */
@SystemSetup(extension = MealeculeInitialDataConstants.EXTENSIONNAME)
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(InitialDataSystemSetup.class);
	public static final String MEALECULE = "mealecule";
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		electronicsImportData.setProductCatalogName(MEALECULE);
		electronicsImportData.setContentCatalogNames(Arrays.asList(MEALECULE));
		electronicsImportData.setStoreNames(Arrays.asList(MEALECULE));
