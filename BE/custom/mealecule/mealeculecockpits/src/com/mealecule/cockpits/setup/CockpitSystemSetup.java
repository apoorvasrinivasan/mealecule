 ...
 */
package com.mealecule.cockpits.setup;
...
import com.mealecule.cockpits.constants.MealeculeCockpitsConstants;
 ...
 */
@SystemSetup(extension = MealeculeCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(MealeculeCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(MealeculeCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						MealeculeCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/mealeculecockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
