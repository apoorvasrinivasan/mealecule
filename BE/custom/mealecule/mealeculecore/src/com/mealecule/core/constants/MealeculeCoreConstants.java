...
/**
 * Global class for all MealeculeCore constants. You can add global constants for your extension into this class.
 */
public final class MealeculeCoreConstants extends GeneratedMealeculeCoreConstants
{
	public static final String EXTENSIONNAME = "mealeculecore";


	private MealeculeCoreConstants()
	{
		//empty
	}
