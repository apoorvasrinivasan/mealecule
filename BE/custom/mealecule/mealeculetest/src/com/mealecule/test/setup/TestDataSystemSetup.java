...
import com.mealecule.test.constants.MealeculeTestConstants;
import com.mealecule.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MealeculeTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/mealeculetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/mealeculetest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/mealeculetest/import/cstickets.impex");
			...
			importImpexFile(context, "/mealeculetest/import/csquotes.impex");
		}
	}
}
