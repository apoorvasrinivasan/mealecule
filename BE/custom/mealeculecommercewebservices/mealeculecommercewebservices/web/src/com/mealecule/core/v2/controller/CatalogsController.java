...
public class CatalogsController extends BaseController
{
	...
	{
		OPTIONS.remove(CatalogOption.PRODUCTS);
	 ...
	 */
	@RequestMapping(value = "/{catalogId}", method = RequestMethod.GET, produces =
			{ MediaType.APPLICATION_JSON_VALUE})
	@ResponseBody
	 ...
	 */
	@RequestMapping(value = "/{catalogId}/{catalogVersionId}", method = RequestMethod.GET, produces =
			{ MediaType.APPLICATION_JSON_VALUE})
	@ResponseBody
	 ...
	 */
	@RequestMapping(value = "/{catalogId}/{catalogVersionId}/categories/{categoryId}", method = RequestMethod.GET, produces =
			{ MediaType.APPLICATION_JSON_VALUE})
	@ResponseBody
