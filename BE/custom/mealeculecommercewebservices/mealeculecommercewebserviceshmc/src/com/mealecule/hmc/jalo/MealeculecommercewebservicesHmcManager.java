 ...
 */
package com.mealecule.hmc.jalo;
...
import com.mealecule.hmc.constants.MealeculecommercewebservicesHmcConstants;
import com.mealecule.hmc.jalo.GeneratedMealeculecommercewebservicesHmcManager;



/**
 * This is the extension manager of the MealeculecommercewebservicesHmc extension.
 */
@SuppressWarnings("deprecation")
public class MealeculecommercewebservicesHmcManager extends GeneratedMealeculecommercewebservicesHmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MealeculecommercewebservicesHmcManager.class.getName());
	 ...
	 */
	public static MealeculecommercewebservicesHmcManager getInstance()
	{
		return (MealeculecommercewebservicesHmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MealeculecommercewebservicesHmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MealeculecommercewebservicesHmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MealeculecommercewebservicesHmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MealeculecommercewebservicesHmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MealeculecommercewebservicesHmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
