...
public class TestSetupUtils
{
	...
	private static void setupCommerce(final BiConsumer<MealeculecommercewebservicesTestSetup, SystemSetupContext> triggerEqualsValidator)
	{
		final MealeculecommercewebservicesTestSetup setup = getCommerceWebServicesTestSetup();
	...
	private static MealeculecommercewebservicesTestSetup getCommerceWebServicesTestSetup()
	{
		return Registry.getApplicationContext().getBean(MealeculecommercewebservicesTestSetup.class,
	...
	private static SystemSetupContext createSystemSetupContext()
	{
		...
		{ "Go" });
		params.put("mealeculecommercewebservicestest_sample", new String[]
		{ "true" });
		...
		return new SystemSetupContext(params, Type.ALL, Process.ALL, "mealeculecommercewebservicestest");
	}
	...
	{
		if (!Config.getBoolean("mealeculecommercewebservicestest.embedded.server.enabled", true))
		{
