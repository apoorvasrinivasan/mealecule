 ...
 */
package com.mealecule.test.setup;
...
public class MealeculecommercewebservicesTestSetup extends AbstractSystemSetup
{
	...
	private static final Logger LOG = Logger.getLogger(MealeculecommercewebservicesTestSetup.class);
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		getSetupImpexService().importImpexFile("/mealeculecommercewebservicestest/import/sampledata/user-orders.impex", true, false);
	...
	{
		return Config.getBoolean("mealeculecommercewebservicestest.enableWsIntegrationTest", false);
	}
	...
	protected void loadOptionalSampleData(final List<String> storeNames)
	{
		...
		{
			storeNames.forEach(store -> getSetupImpexService().importImpexFile(String.format("/mealeculecommercewebservicestest/import/acceleratorwebservicesaddon/%s/solr.impex", store), true, true));
		}

		if (extensionNames.contains("yacceleratorfulfilmentprocess"))
		{
			getSetupImpexService().importImpexFile("/mealeculecommercewebservicestest/import/orderprocess/store.impex", true, true);
		}
	}

	public void initializePromotionEngineModule()
	{
		getSetupImpexService().importImpexFile("/mealeculecommercewebservicestest/import/promotionengine/promotionsmodule.impex", true,
				false);
	}
	...
	protected void loadIntegrationData()
	{
		...
		{
			getSetupImpexService().importImpexFile("/mealeculecommercewebservicestest/import/integration/cis-integration-data.impex", true);
		}

		if (extensionNames.contains("omssampledata"))
		{
			getSetupImpexService().importImpexFile("/mealeculecommercewebservicestest/import/integration/oms-integration-data.impex", true);
		}
	}
	...
	protected void loadMultiDimensionalData()
	{
		getSetupImpexService().importImpexFile(
				"/mealeculecommercewebservicestest/import/sampledata/productCatalogs/wsTestProductCatalog/dimension-categories.impex", true,
				false);
		getSetupImpexService().importImpexFile(
				"/mealeculecommercewebservicestest/import/sampledata/productCatalogs/wsTestProductCatalog/dimension-products.impex", true,
				false);
		getSetupImpexService().importImpexFile(
				"/mealeculecommercewebservicestest/import/sampledata/productCatalogs/wsTestProductCatalog/dimension-products-prices.impex",
				true, false);
		getSetupImpexService()
				.importImpexFile(
						"/mealeculecommercewebservicestest/import/sampledata/productCatalogs/wsTestProductCatalog/dimension-products-stock-levels.impex",
						true, false);
