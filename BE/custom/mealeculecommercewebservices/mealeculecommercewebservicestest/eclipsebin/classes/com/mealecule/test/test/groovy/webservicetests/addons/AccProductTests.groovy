...
import com.mealecule.test.test.groovy.webservicetests.v1.BaseWSTest
...
class AccProductTests extends BaseWSTest {
	...
	public void ignoreIf(){
		org.junit.Assume.assumeTrue(Config.getBoolean("mealeculecommercewebservicestest.enableAccTest", false)
