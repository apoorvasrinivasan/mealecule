...
import com.mealecule.test.test.groovy.webservicetests.TestNamePrinter
import com.mealecule.test.test.groovy.webservicetests.TestUtil
import com.mealecule.test.test.groovy.webservicetests.config.TestConfigFactory
import com.mealecule.test.test.groovy.webservicetests.docu.BaseWSTestWatcher
...
class BaseWSTest {
	...
	public void ignoreIf(){
		org.junit.Assume.assumeTrue(Config.getBoolean("mealeculecommercewebservicestest.enableV1", false))
	}
	...
	protected BaseWSTest() {
		config = TestConfigFactory.createConfig("v1", "/mealeculecommercewebservicestest/groovytests-property-file.groovy");
