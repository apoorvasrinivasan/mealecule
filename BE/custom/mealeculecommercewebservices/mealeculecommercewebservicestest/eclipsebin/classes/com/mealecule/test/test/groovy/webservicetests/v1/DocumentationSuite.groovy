 ...
 *
 */
package com.mealecule.test.test.groovy.webservicetests.v1
import de.hybris.bootstrap.annotations.ManualTest
import com.mealecule.test.test.groovy.webservicetests.DocumentationSuiteGuard
import com.mealecule.test.test.groovy.webservicetests.TestUtil
import com.mealecule.test.test.groovy.webservicetests.docu.SaveWSOutputStrategy
import com.mealecule.test.test.groovy.webservicetests.docu.TestUtilCustomDelegatingMetaClass
import com.mealecule.test.test.groovy.webservicetests.markers.AvoidCollectingOutputFromTest
import com.mealecule.test.test.groovy.webservicetests.markers.CollectOutputFromTest
...
/**
 * Suite contains all tests from {@link com.mealecule.test.test.groovy.webservicetests.v1.AllTests} suite, including test from {@link CollectOutputFromTest} category
